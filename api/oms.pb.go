...
type ItemsWithQuantities struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ItemsWithQuantities) Reset() {
	*x = ItemsWithQuantities{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemsWithQuantities) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemsWithQuantities) ProtoMessage() {}

func (x *ItemsWithQuantities) ProtoReflect() protoreflect.Message {
	mi := &file_api_oms_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemsWithQuantities.ProtoReflect.Descriptor instead.
func (*ItemsWithQuantities) Descriptor() ([]byte, []int) {
	return file_api_oms_proto_rawDescGZIP(), []int{2}
}

func (x *ItemsWithQuantities) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
func (x *ItemsWithQuantities) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
type CreateOrderRequest struct {
	...
	Items      []*ItemsWithQuantities `protobuf:"bytes,2,rep,name=Items,proto3" json:"Items,omitempty"`
}
...
func (x *CreateOrderRequest) GetItems() []*ItemsWithQuantities {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_api_oms_proto_rawDesc = []byte{
	...
	0x07, 0x50, 0x72, 0x69, 0x63, 0x65, 0x49, 0x44, 0x22, 0x41, 0x0a, 0x13, 0x49, 0x74, 0x65, 0x6d,
	0x73, 0x57, 0x69, 0x74, 0x68, 0x51, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12,
	...
	0x64, 0x12, 0x2e, 0x0a, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x18, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x57, 0x69, 0x74, 0x68,
	0x51, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x52, 0x05, 0x49, 0x74, 0x65, 0x6d,
	0x73, 0x22, 0x15, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x42, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65,
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x76, 0x69, 0x70, 0x6f, 0x73,
	0x38, 0x39, 0x2f, 0x6f, 0x6d, 0x73, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x61, 0x70,
...
var file_api_oms_proto_goTypes = []interface{}{
	...
	(*Item)(nil),                // 1: api.Item
	(*ItemsWithQuantities)(nil), // 2: api.ItemsWithQuantities
...
var file_api_oms_proto_depIdxs = []int32{
	...
	2, // 1: api.CreateOrderRequest.Items:type_name -> api.ItemsWithQuantities
...
func file_api_oms_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_oms_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ItemsWithQuantities); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
